...
accionLabControllers.factory('customerRepository', ['$http', "$rootScope", function ($http, $rootScope) {
    ...
    return {
        ...
        getCustomer: function (id) {
            return $http.get(urlCustomer + id, { headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' } });
        },
        exportCustomer: function (id) {
            return $http.get('Clients/ExportClient/' + id, { headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' } });
        },
        exportCustomers: function (filters) {
            filters.Clients = null;
            return $http.post('api/exportclients/', filters, { headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' } });
        },
        exportCustomersTracking: function (filters) {
            filters.Clients = null;
            return $http.post('api/exportclientstracking', filters, { headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' } });
        },
        searchCustomers: function (searchTerm, searchField, limit) {
            ...
            return $http.get(searchUrl, { headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' } });
        },
        ...
        getEducationTypes: function (callback) {
            return $http.get('api/EducationTypes', { headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' } });
        },
        ...
        getLanguages: function (callback) {
            return $http.get('api/Languages', { headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' } });
        },
        getLanguageLevels: function (callback) {
            return $http.get('api/LanguageLevels', { headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' } });
        },
        getTrackingTypes: function () {
            return $http.get('api/trackingtypes', { headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' } });
        },
        getStates: function(){
            return $http.get('api/States', { headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' } });
        },
        ...
        InsertCustomer: function (callback, client) {
            ...
            return $http.post(urlCustomer, newClient, { headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' } });
        },
        Refresh: function () {
            return $http.post('api/refreshclients', null, { headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' } })
        },
        InsertTracking: function (tracking) {
            return $http.post('api/TrackingDetails', tracking, { headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' } })
        },
        //method for update
        UpdateCustomer: function (client) {
            
            return $http.put(urlCustomer + client.ClientId, client, { headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' } });
        },
        ...
        ChangeValues: function (client) {
            return $http({
                ...
                data: client,
                headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' }
            });
        },
        UpdateTracking: function (client) {
            return $http.put('api/Trackings/' + client.Trackings[0].TrackingId, client, { headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' } });
        },
        inscribeCustomer: function (client) {
            ...
            return $http.put("api/enrollclient/" + newClient.ClientId, newClient, { headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' } });
        },
        //method for delete
        DeleteCustomer: function (callback, id) {
            return $http.delete(urlCustomer + '/' + id, { headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' } });
        },
        //method for delete
        DeleteTracking: function (id) {
            return $http.delete('api/TrackingDetails' + '/' + id, { headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' } });
        }
        ,
        findClientByIdentityNumber: function (id) {
            //return $http.get('api/FindClientByIdentityNumber' + '/' + id, { headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' } });
            return $http.post('api/FindClientByIdentityNumber' , id, { headers: { 'Authorization': 'Bearer ' + $rootScope.userToken, 'Content-Type': 'application/json; charset=utf-8' } });
        }
